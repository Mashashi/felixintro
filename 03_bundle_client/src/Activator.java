    ...
    **/
    public void start(BundleContext context) throws Exception
    {
        ...
        synchronized (this)
        {
            ...
            m_context.addServiceListener(this, "(&(objectClass=tutorial.inter.DictionaryService)(Language=English))");
            ...
            ServiceReference[] refs = m_context.getServiceReferences("tutorial.inter.DictionaryService","(Language=English)");
